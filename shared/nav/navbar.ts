interface NavbarData {
  ...
  _ticking: boolean;
  _pluginPromise: Promise<void> | null;
  ...
  readonly $refs?: { mobileMenu?: HTMLElement };

  get pluginsReady(): boolean;
  ...
  Alpine.data(
    ...
    (): NavbarData => ({
      ...
      getCurrentLanguageObj(): { code: string; label: string; flag: string } | null {
        ...
        return languages.find((lang) => lang.code === current) ?? null;
      },

...
const isSPA = buildConfig.BUILD_MODE === 'spa';
...
export default defineConfig({
  ...
  define: {
    __BUILD_MODE__: JSON.stringify(buildConfig.BUILD_MODE),
    __DEFAULT_LANG__: JSON.stringify(buildConfig.DEFAULT_LANG),
    __DEBUG__: buildConfig.DEBUG,
  },
  build: {
    emptyOutDir: true,
    rollupOptions: {
